(() => {
    ...
    function initSliders() {
        if (document.querySelector(".insights__slider")) new swiper_core_Swiper(".insights__slider", {
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        document.addEventListener("click", (function(e) {
            if (!e.target.closest(".submenu") && !e.target.closest(".drop-list")) closeAllSubmenus();
        }));
    }));
    window["FLS"] = true;
    menuInit();
